...
import { 
  ...
  ScrollViewProps, 
  CoverProps,
  ImageBackgroundProps } from '../Interfaces/GenericComponentsProps'
...
export const Text = styled.Text.attrs(props => ({ onPress: props.onPress })) <TextProps>`
  color: ${props => colors[props.color || 'dark']};
...
export const Cover = styled.ImageBackground.attrs((props: ImageBackgroundProps) => ({
  source: props.image 
    ? {
        uri: props.image,
      }
